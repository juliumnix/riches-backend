...
class BalanceController {
  async insereEntrada(request, response) {
    const { id_usuario, valor, entrada } = request.body;
    const responseAPI = await BalanceRepository.createEntrada(
      id_usuario,
      valor,
      entrada
    );
  ...
  async index(request, response) {
    ...
    const contacts = await BalanceRepository.findAll(id);
